...
for ((k=0;k<group_numbers;k++));do
    ...
    if [ "${group_as}" != "IXP" ];then
        ...
        for ((i=0;i<n_routers;i++)); do
            ...
            echo " -c 'ip prefix-list OWN_PREFIX seq 5 permit 1.0.0.0/8' \\" >> "${location}"
            echo " -c 'ip prefix-list OWN_PREFIX seq 10 permit 2.0.0.0/8' \\" >> "${location}"
            echo " -c 'ip prefix-list OWN_PREFIX seq 15 permit 3.0.0.0/8' \\" >> "${location}"
            echo " -c 'ip prefix-list OWN_PREFIX seq 20 permit 4.0.0.0/8' \\" >> "${location}"
            echo " -c 'ip prefix-list OWN_PREFIX seq 25 permit 5.0.0.0/8' \\" >> "${location}"
            echo " -c 'ip prefix-list OWN_PREFIX seq 30 permit 6.0.0.0/8' \\" >> "${location}"
            echo " -c 'ip prefix-list OWN_PREFIX seq 35 permit 7.0.0.0/8' \\" >> "${location}"
            echo " -c 'ip prefix-list OWN_PREFIX seq 45 permit 8.0.0.0/8' \\" >> "${location}"
            echo " -c 'ip prefix-list OWN_PREFIX seq 55 permit 9.0.0.0/8' \\" >> "${location}"
            echo " -c 'ip prefix-list OWN_PREFIX seq 65 permit 10.0.0.0/8' \\" >> "${location}"
            echo " -c 'ip prefix-list OWN_PREFIX seq 75 permit 11.0.0.0/8' \\" >> "${location}"
            echo " -c 'ip prefix-list OWN_PREFIX seq 85 permit 12.0.0.0/8' \\" >> "${location}"
            echo " -c 'ip prefix-list OWN_PREFIX seq 95 permit 13.0.0.0/8' \\" >> "${location}"
            echo " -c 'ip prefix-list OWN_PREFIX seq 80 permit 14.0.0.0/8' \\" >> "${location}"
            echo " -c 'ip prefix-list OWN_PREFIX seq 90 permit 15.0.0.0/8' \\" >> "${location}"
